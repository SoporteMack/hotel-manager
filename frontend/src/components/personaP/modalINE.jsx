...
export default function ModalINE({
  ...
  const handleCapturaA = (imagenBase64) => {
    ...
    setDocs((prev) => ({ ...prev, tarjetaA: archivo }));
  ...
  const handleCapturaD = (imagenBase64) => {
    ...
    setDocs((prev) => ({ ...prev, tarjetaD: archivo }));
  ...
  const handleGuardar = async () => {
    ...
    try {
      ...
      formData.append("ineA", docs.tarjetaA);
      formData.append("ineD", docs.tarjetaD);
      ...
      const res = await agregarine(formData);
          ...
          <DialogPanel className="w-full max-w-sm sm:max-w-2xl rounded-lg bg-white p-6 shadow-md">
            ...
            <div className="flex flex-col sm:flex-row gap-6 mb-6">
              ...
              <div className="flex flex-col gap-4 flex-1">
                ...
                {docs.tarjetaA && (
                  <div className="mt-3 w-full border rounded overflow-hidden">
