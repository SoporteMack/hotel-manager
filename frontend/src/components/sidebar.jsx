    ...
    >
      ...
      <div className="flex flex-col h-full min-h-screen justify-between bg-white p-4 overflow-y-auto">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Sección RENTAS */}
          <details className="flex flex-col gap-2 border-b border-gray-200 pb-2">
            <summary className="text-[#121516] text-base font-medium cursor-pointer select-none">
              RENTAS
            </summary>
            ...
            {/* Botón cerrar sesión dentro del details */}
            <button
              onClick={handleLogout}
              className="mt-2 flex items-center gap-3 px-3 py-2 rounded-xl hover:bg-gray-100 text-gray-600 w-full"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
